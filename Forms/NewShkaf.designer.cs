namespace ArmenDiplom
{
    partial class NewShkaf
    {
        ...
        private void InitializeComponent()
        {
          ...
          this.label1.Text = "Введите номер модули:\r\n(6-и значное число)";
          this.label1.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
          // 
          // shkafNumberTextBox
          // 
          this.errorNewShkaf.SetIconPadding(this.shkafNumberTextBox, 10);
          this.shkafNumberTextBox.Location = new System.Drawing.Point(276, 28);
          ...
          this.shkafNumberTextBox.Size = new System.Drawing.Size(218, 26);
          ...
          this.installShkafDateTimePicker.Location = new System.Drawing.Point(276, 86);
          ...
          this.label10.Text = "3-ий пароль (6-и значное число)";
          // 
          // label9
          // 
          ...
          this.label9.Text = "2-ой пароль (6-и значное число)";
          // 
          // label8
          // 
          ...
          this.label7.Text = "Чтобы задать пароли модуля, нужно сначала ввести административный пароль";
          ...
          this.createNewShkafButton.Text = "Создать новый модуль";
